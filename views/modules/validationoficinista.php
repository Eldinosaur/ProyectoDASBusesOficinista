<div style="padding-left: 30px; padding-right: 30px; padding-top: 15px;">
    <table class="table table-striped">
        ...
        <tbody>
            <?php
            $url = 'https://nilotic-quart.000webhostapp.com/listarVentas.php?id_cooperativa='.$_SESSION['id_coop'];
            $ch = curl_init($url);
                ...
                for ($i = 0; $i < sizeof($val); $i++) {
                    if (isset($val[$i]['id_venta']) != null) {
                        ...
                        <tr>
                            <td colspan="7">
                                <center>
                                    No Existen Ventas pendientes de validacion
                                </center>
                            </td>
                        </tr>
                        <?php
