    ...
    <form id="newBus" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="carroceria_bus" id="carroceria_bus" placeholder="Carroceria"
          value="<?php echo $carroceria_bus ?>" required>
      </div>
      <div class="mb-3">
        <label for="cantidad_asientos" class="form-label" style="font-weight:bold;">Numero de asientos</label>
        <input type="text" class="form-control" value="<?php echo $cantidad_asientos ?>" name="cantidad_asientos"
          id="cantidad_asientos" readonly>
      </div>
      <div class="mb-3">
        ...
        <select class="form-control" name="id_socio" id="id_socio" readonly>
          ...
          if ($json != null) {
            ...
            for ($i = 0; $i < sizeof($val); $i++) {
              ...
              ?>
              <option value="<?php echo $id_socio_datos ?>" <?php if ($id_socio_datos == $id_socio) {
                  echo 'selected';
                } ?>><?php echo "Cedula: " . $cedula_socio . " Nombre: " . $nombre_socio . " " . $apellido_socio; ?></option>
            <?php }
          } ?>
        </select>
      </div>
          ...
          .then(function (url) {
            ...
            $.ajax({
              ...
              success: function (response) {
                ...
                alert("Se Actualizaron los Datos del Bus");
              ...
              error: function (xhr, status, error) {
                ...
                alert("No se Actualizaron los Datos del Bus");
